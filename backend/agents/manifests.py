...
MANIFESTS: Dict[str, Dict[str, Any]] = {
    ...
    "hr_mentor": {
        ...
        "tools":              ["search_memory", "escalate_to_hermes"],
        "tariff_tier":        "simple",
        "icon":               "GraduationCap",
        "color":              "violet",
    },
    ...
    "analyst": {
        ...
        "decision_authority": AUTHORITY_ADVISORY,
        "tools":              ["search_memory", "evaluate_action_roi", "escalate_to_hermes"],
        "tariff_tier":        "enterprise",
        "icon":               "TrendingUp",
        "color":              "cyan",
    },
    ...
    "marketer": {
        ...
        "decision_authority": AUTHORITY_ADVISORY,
        "tools":              ["search_memory", "suggest_next_best_action", "escalate_to_hermes"],
        "tariff_tier":        "pro",
        "icon":               "Radar",
        "color":              "orange",
    },
    ...
    "compliance": {
        ...
        "decision_authority": AUTHORITY_ADVISORY,
        "tools":              ["search_memory", "mempalace_search", "escalate_to_hermes"],
        "tariff_tier":        "pro",
        "icon":               "Shield",
        "color":              "slate",
    },
